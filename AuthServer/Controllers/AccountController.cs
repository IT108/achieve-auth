...
namespace AuthServer.Controllers
{
	public class AccountController : Controller
	{
		...
		public AccountController(SignInManager<AppUser> signInManager, UserManager<AppUser> userManager, IIdentityServerInteractionService interaction, IAuthenticationSchemeProvider schemeProvider, IClientStore clientStore, IEventService events, Microsoft.Extensions.Configuration.IConfiguration config)
		{
		...
		[HttpPost]
		[Route("api/[controller]/setGroup")]
		public async Task<IActionResult> setGroups([FromQuery] [Required] string username, [FromQuery] [Required] string key, [FromQuery] [Required] string group)
		{
			if (key != _config["KEY"])
			{
		...
		[HttpPost]
		[Route("api/[controller]/removeGroup")]
		public async Task<IActionResult> removeGroups([FromQuery] [Required] string username, [FromQuery] [Required] string key, [FromQuery] [Required] string group)
		{
			if (key != _config["KEY"])
			{
				return StatusCode(StatusCodes.Status401Unauthorized);
